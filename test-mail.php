<?php
	...
	try {
		$mail = new Mail();
		$mail->protocol = "smtp";
		$mail->parameter = "-ffkbsolutionteam@gmail.com";
		$mail->smtp_hostname = "ssl://smtp.gmail.com";
		$mail->smtp_username = "fkbsolutionteam@gmail.com";
		$mail->smtp_password = html_entity_decode("Qwerty123$%^", ENT_QUOTES, 'UTF-8');
		$mail->smtp_port = "465";
		$mail->smtp_timeout = "20";

		// email to manu
		$mail->setTo("kceditor102@gmail.com");
		$mail->setFrom("fkbsolutionteam@gmail.com");
		$mail->setSender("FKB Team");
		
		$mail->setSubject("Test email Subject");
		// load template from html for order
		$mail->setHtml("Test email Content");
		$mail->send();
